 ...
 * @subpackage Rayolabs_music_king/admin
 */
 ...
 */
class Rayolabs_music_king_Admin {
	...
	public function __construct( $plugin_name, $version,$api_url ) {
		...
		$this->rayolabs_publicapi_music = get_option($this->plugin_name);
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/rayolabs_music_king-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/rayolabs_music_king-admin.js', array( 'jquery' ), $this->version, false );
...
public function add_plugin_admin_menu() {
     ...
     *
     */
    add_options_page( 'Rayolabs Public Api Music Content King Base Options Functions Setup', 'RayoLabs PublicApi Music King', 'manage_options', $this->plugin_name, array($this, 'display_plugin_setup_page')
    );
}
/**
